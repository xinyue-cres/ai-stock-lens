  ...
  "scenarios": [
    {
      ...
      "description": "<=40字",
      "conditions": [{"kind": "price", "op": "<=", "value": float, "target": "close"}],
      "risk_reward": "如 1:2.5"
    }
  ]
}
...
confidence 校准：
- opportunity_level="strong" + 概率>65% + 强支撑 → confidence 0.5-0.7
- opportunity_level="moderate" → confidence 0.3-0.5
- opportunity_level="weak" 或 "none" → confidence < 0.3
左侧交易本身就是低确定性高赔率，confidence 不应超过 0.7。
"""
