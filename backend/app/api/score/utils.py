...
def _serialize_combined(r) -> dict:
    ...
    return {
        ...
        "hist_death_trough_pct": getattr(r, "hist_death_trough_pct", None),
        "hist_death_trough_median": getattr(r, "hist_death_trough_median", None),
        "weekly_is_golden": getattr(r, "weekly_is_golden", None) if hasattr(r, "weekly_is_golden") else None,
